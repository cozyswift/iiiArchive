...
const EmailAddress = 'scalar EmailAddress';
const GUID = `scalar GUID`;
const Hexadecimal = `scalar Hexadecimal`;
const HexColorCode = `scalar HexColorCode`;
const HSL = `scalar HSL`;
const HSLA = `scalar HSLA`;
const IBAN = `scalar IBAN`;
const IPv4 = `scalar IPv4`;
const IPv6 = `scalar IPv6`;
const ISBN = `scalar ISBN`;
const JSON$1 = `scalar JSON`;
const JSONObject = `scalar JSONObject`;
const MAC = `scalar MAC`;
const NegativeFloat = 'scalar NegativeFloat';
const NegativeInt = 'scalar NegativeInt';
const NonNegativeFloat = 'scalar NonNegativeFloat';
const NonNegativeInt = 'scalar NonNegativeInt';
const NonPositiveFloat = 'scalar NonPositiveFloat';
const NonPositiveInt = 'scalar NonPositiveInt';
const PhoneNumber = 'scalar PhoneNumber';
const Port = `scalar Port`;
const PositiveFloat = 'scalar PositiveFloat';
const PositiveInt = 'scalar PositiveInt';
const PostalCode = 'scalar PostalCode';
const RGB = `scalar RGB`;
const RGBA = `scalar RGBA`;
const URL$1 = 'scalar URL';
const USCurrency = `scalar USCurrency`;
const UnsignedFloat = 'scalar UnsignedFloat';
const UnsignedInt = 'scalar UnsignedInt';
const Long = 'scalar Long';
const ObjectID = 'scalar ObjectID';
const typeDefs = [
    DateTime,
    EmailAddress,
    NegativeFloat,
...
const DateTime$1 = new graphql.GraphQLScalarType({
    name: 'DateTime',
...
const NonPositiveInt$1 = new graphql.GraphQLScalarType({
    name: 'NonPositiveInt',
...
const PositiveInt$1 = new graphql.GraphQLScalarType({
    name: 'PositiveInt',
...
const NegativeInt$1 = new graphql.GraphQLScalarType({
    name: 'NegativeInt',
...
const NonPositiveFloat$1 = new graphql.GraphQLScalarType({
...
const PositiveFloat$1 = new graphql.GraphQLScalarType({
    name: 'PositiveFloat',
...
const NegativeFloat$1 = new graphql.GraphQLScalarType({
    name: 'NegativeFloat',
...
/* eslint-enable */
const EmailAddress$1 = new graphql.GraphQLScalarType({
    name: 'EmailAddress',
...
const URL$2 = new graphql.GraphQLScalarType({
    name: 'URL',
...
const PhoneNumber$1 = new graphql.GraphQLScalarType({
    name: 'PhoneNumber',
...
const PostalCode$1 = new graphql.GraphQLScalarType({
    name: 'PostalCode',
...
function BigIntFactory (name = 'BigInt') {
    BigInt.prototype.toJSON = BigInt.prototype.toJSON || function () { return this.toString(); };
    return new graphql.GraphQLScalarType({
        name,
...
const GUID$1 = new graphql.GraphQLScalarType({
    name: `GUID`,
...
const Hexadecimal$1 = new graphql.GraphQLScalarType({
    name: `Hexadecimal`,
...
const HexColorCode$1 = new graphql.GraphQLScalarType({
    name: `HexColorCode`,
...
const HSL$1 = new graphql.GraphQLScalarType({
    name: `HSL`,
...
const HSLA$1 = new graphql.GraphQLScalarType({
    name: `HSLA`,
...
const IPv4$1 = new graphql.GraphQLScalarType({
    name: `IPv4`,
...
const IPv6$1 = new graphql.GraphQLScalarType({
    name: `IPv6`,
...
const ISBN$1 = new graphql.GraphQLScalarType({
    name: `ISBN`,
...
const MAC$1 = new graphql.GraphQLScalarType({
    name: `MAC`,
...
const Port$1 = new graphql.GraphQLScalarType({
    name: `Port`,
...
const RGB$1 = new graphql.GraphQLScalarType({
    name: `RGB`,
...
const RGBA$1 = new graphql.GraphQLScalarType({
    name: `RGBA`,
 ...
 *    currency strings.
 */
const USCurrency$1 = new graphql.GraphQLScalarType({
    name: 'USCurrency',
...
const JSON$2 = new graphql.GraphQLScalarType({
    name: 'JSON',
...
const JSONObject$1 = new graphql.GraphQLScalarType({
    name: 'JSONObject',
...
const IBAN_SPECIFICATIONS = {
    'AD': { length: 24, structure: 'F04F04A12', example: 'AD1200012030200359100100' },
    ...
    'BY': { length: 28, structure: 'A04F04A16', example: 'BY13NBRB3600900000002Z00AB00' },
    'CH': { length: 21, structure: 'F05A12', example: 'CH9300762011623852957' },
    'CI': { length: 28, structure: 'U02F22', example: 'CI70CI1234567890123456789012' },
    ...
    'IQ': { length: 23, structure: 'U04F03A12', example: 'IQ98NBIQ850123456789012' },
    ...
    'PL': { length: 28, structure: 'F08F16', example: 'PL61109010140000071219812874' },
    ...
    'SC': { length: 31, structure: 'U04F04F16U03', example: 'SC18SSCB11010000000000001497USD' },
    ...
    'SV': { length: 28, structure: 'U04F20', example: 'SV62CENR00000000000000700025' },
...
function parseStructure(structure) {
    ...
    const regex = structure.match(/(.{3})/g).map(function (block) {
        ...
        let format, pattern = block.slice(0, 1), repeats = parseInt(block.slice(1), 10);
        switch (pattern) {
            case 'A':
                format = '0-9A-Za-z';
                break;
...
const IBAN$1 = new graphql.GraphQLScalarType({
    name: `IBAN`,
...
const ObjectID$1 = new graphql.GraphQLScalarType({
    name: 'ObjectID',
...
const DateTime$2 = () => new Date();
const EmailAddress$2 = () => 'test@test.com';
const NegativeFloat$2 = () => -123.45;
const NegativeInt$2 = () => -123;
const NonNegativeFloat$1 = () => 123.45;
const NonNegativeInt$1 = () => 123;
const NonPositiveFloat$2 = () => -123.45;
const NonPositiveInt$2 = () => -123;
const PhoneNumber$2 = () => '+17895551234';
const ObjectID$2 = () => '5e5677d71bdc2ae76344968c';
const PositiveFloat$2 = () => 123.45;
const PositiveInt$2 = () => 123;
const PostalCode$2 = () => '60031';
const URLMock = () => {
...
const HexColorCode$2 = () => '#' + Math.floor(Math.random() * 16777215).toString(16);
const Hexadecimal$2 = () => Math.floor(Math.random() * 16777215).toString(16);
const randomVal = (min, max) => {
    return Math.floor(Math.random() * (max - min) + 1) + min;
};
// https://codepen.io/meowwwls/pen/jbEJRp
const HSL$2 = () => `hsl(${randomVal(0, 360)}, ${randomVal(30, 95)}%, ${randomVal(30, 80)}%)`;
const HSLA$2 = () => `hsla(${randomVal(0, 360)}, ${randomVal(30, 95)}%, ${randomVal(30, 80)}%, ${Math.random()})`;
// https://stackoverflow.com/questions/43464519/creating-fake-ip-address-using-javascript
const IPv4$2 = () => (Math.floor(Math.random() * 255) + 1) + '.' + (Math.floor(Math.random() * 255) + 0) + '.' + (Math.floor(Math.random() * 255) + 0) + '.' + (Math.floor(Math.random() * 255) + 0);
const IPv6$2 = () => '2001:0db8:85a3:0000:0000:8a2e:0370:7334';
// http://jsfiddle.net/guest271314/qhbC9/
const MAC$2 = () => 'XX:XX:XX:XX:XX:XX'.replace(/X/g, () => '0123456789ABCDEF'.charAt(Math.floor(Math.random() * 16)));
const Port$2 = () => randomVal(0, 65535);
const RGB$2 = () => `rgb(${randomVal(0, 255)}, ${randomVal(0, 255)}, ${randomVal(0, 255)})`;
const RGBA$2 = () => `rgba(${randomVal(0, 255)}, ${randomVal(0, 255)}, ${randomVal(0, 255)}, ${Math.random()})`;
const ISBN$2 = () => `978-3-16-148410-0`;
const USCurrency$2 = () => 1000;
const JSON$3 = () => ({});
const JSONObject$2 = () => ({});
const IBAN$2 = () => 'NL55INGB4789170233';

const mocks = /*#__PURE__*/Object.freeze({
  __proto__: null,
  DateTime: DateTime$2,
  EmailAddress: EmailAddress$2,
  NegativeFloat: NegativeFloat$2,
  NegativeInt: NegativeInt$2,
  NonNegativeFloat: NonNegativeFloat$1,
  NonNegativeInt: NonNegativeInt$1,
  NonPositiveFloat: NonPositiveFloat$2,
  NonPositiveInt: NonPositiveInt$2,
  PhoneNumber: PhoneNumber$2,
  ObjectID: ObjectID$2,
  PositiveFloat: PositiveFloat$2,
  PositiveInt: PositiveInt$2,
  PostalCode: PostalCode$2,
  GUID: GUID$2,
  HexColorCode: HexColorCode$2,
  ...
  RGBA: RGBA$2,
  ISBN: ISBN$2,
  USCurrency: USCurrency$2,
  JSON: JSON$3,
  JSONObject: JSONObject$2,
  IBAN: IBAN$2,
  URL: URLMock,
  UnsignedInt: NonNegativeInt$1,
  UnsignedFloat: NonNegativeFloat$1,
  Long: BigIntMock,
  BigInt: BigIntMock
});
...
exports.DateTimeMock = DateTime$2;
exports.DateTimeResolver = DateTime$1;
exports.DateTimeTypeDefinition = DateTime;
exports.EmailAddressMock = EmailAddress$2;
exports.EmailAddressResolver = EmailAddress$1;
exports.EmailAddressTypeDefinition = EmailAddress;
exports.GUIDDefinition = GUID;
exports.GUIDMock = GUID$2;
exports.GUIDResolver = GUID$1;
exports.HSLADefinition = HSLA;
exports.HSLAMock = HSLA$2;
exports.HSLAResolver = HSLA$1;
exports.HSLDefinition = HSL;
exports.HSLMock = HSL$2;
exports.HSLResolver = HSL$1;
exports.HexColorCodeDefinition = HexColorCode;
exports.HexColorCodeMock = HexColorCode$2;
exports.HexColorCodeResolver = HexColorCode$1;
exports.HexadecimalMock = Hexadecimal$2;
exports.HexadecimalResolver = Hexadecimal$1;
exports.HexadecimalTypeDefinition = Hexadecimal;
exports.IBANMock = IBAN$2;
exports.IBANResolver = IBAN$1;
exports.IBANTypeDefinition = IBAN;
exports.IPv4Definition = IPv4;
exports.IPv4Mock = IPv4$2;
exports.IPv4Resolver = IPv4$1;
exports.IPv6Definition = IPv6;
exports.IPv6Mock = IPv6$2;
exports.IPv6Resolver = IPv6$1;
exports.ISBNDefinition = ISBN;
exports.ISBNMock = ISBN$2;
exports.ISBNResolver = ISBN$1;
exports.JSONDefinition = JSON$1;
exports.JSONMock = JSON$3;
exports.JSONObjectDefinition = JSONObject;
exports.JSONObjectMock = JSONObject$2;
exports.JSONObjectResolver = JSONObject$1;
exports.JSONResolver = JSON$2;
exports.LongMock = BigIntMock;
exports.LongResolver = LongResolver;
exports.LongTypeDefinition = Long;
exports.MACDefinition = MAC;
exports.MACMock = MAC$2;
exports.MACResolver = MAC$1;
exports.NegativeFloatMock = NegativeFloat$2;
exports.NegativeFloatResolver = NegativeFloat$1;
exports.NegativeFloatTypeDefinition = NegativeFloat;
exports.NegativeIntMock = NegativeInt$2;
exports.NegativeIntResolver = NegativeInt$1;
exports.NegativeIntTypeDefinition = NegativeInt;
exports.NonNegativeFloatMock = NonNegativeFloat$1;
exports.NonNegativeFloatResolver = NonNegativeFloatResolver;
exports.NonNegativeFloatTypeDefinition = NonNegativeFloat;
exports.NonNegativeIntMock = NonNegativeInt$1;
exports.NonNegativeIntResolver = NonNegativeIntResolver;
exports.NonNegativeIntTypeDefinition = NonNegativeInt;
exports.NonPositiveFloatMock = NonPositiveFloat$2;
exports.NonPositiveFloatResolver = NonPositiveFloat$1;
exports.NonPositiveFloatTypeDefinition = NonPositiveFloat;
exports.NonPositiveIntMock = NonPositiveInt$2;
exports.NonPositiveIntResolver = NonPositiveInt$1;
exports.NonPositiveIntTypeDefinition = NonPositiveInt;
exports.ObjectIDMock = ObjectID$2;
exports.ObjectIDResolver = ObjectID$1;
exports.ObjectIDTypeDefinition = ObjectID;
exports.PhoneNumberMock = PhoneNumber$2;
exports.PhoneNumberResolver = PhoneNumber$1;
exports.PhoneNumberTypeDefinition = PhoneNumber;
exports.PortDefinition = Port;
exports.PortMock = Port$2;
exports.PortResolver = Port$1;
exports.PositiveFloatMock = PositiveFloat$2;
exports.PositiveFloatResolver = PositiveFloat$1;
exports.PositiveFloatTypeDefinition = PositiveFloat;
exports.PositiveIntMock = PositiveInt$2;
exports.PositiveIntResolver = PositiveInt$1;
exports.PositiveIntTypeDefinition = PositiveInt;
exports.PostalCodeMock = PostalCode$2;
exports.PostalCodeResolver = PostalCode$1;
exports.PostalCodeTypeDefinition = PostalCode;
exports.RGBADefinition = RGBA;
exports.RGBAMock = RGBA$2;
exports.RGBAResolver = RGBA$1;
exports.RGBDefinition = RGB;
exports.RGBMock = RGB$2;
exports.RGBResolver = RGB$1;
exports.RegularExpression = RegularExpression;
exports.URLMock = URLMock;
exports.URLResolver = URL$2;
exports.URLTypeDefinition = URL$1;
exports.USCurrencyDefinition = USCurrency;
exports.USCurrencyMock = USCurrency$2;
exports.USCurrencyResolver = USCurrency$1;
exports.UnsignedFloatMock = NonNegativeFloat$1;
exports.UnsignedFloatResolver = UnsignedFloatResolver;
exports.UnsignedFloatTypeDefinition = UnsignedFloat;
exports.UnsignedIntMock = NonNegativeInt$1;
