...
const DateTime$1 = new GraphQLScalarType({
    name: 'DateTime',
...
const NonPositiveInt$1 = new GraphQLScalarType({
    name: 'NonPositiveInt',
...
const PositiveInt$1 = new GraphQLScalarType({
    name: 'PositiveInt',
...
const NegativeInt$1 = new GraphQLScalarType({
    name: 'NegativeInt',
...
const NonPositiveFloat$1 = new GraphQLScalarType({
...
const PositiveFloat$1 = new GraphQLScalarType({
    name: 'PositiveFloat',
...
const NegativeFloat$1 = new GraphQLScalarType({
    name: 'NegativeFloat',
...
/* eslint-enable */
const EmailAddress$1 = new GraphQLScalarType({
    name: 'EmailAddress',
...
const URL$2 = new GraphQLScalarType({
    name: 'URL',
...
const PhoneNumber$1 = new GraphQLScalarType({
    name: 'PhoneNumber',
...
const PostalCode$1 = new GraphQLScalarType({
    name: 'PostalCode',
...
const GUID$1 = new GraphQLScalarType({
    name: `GUID`,
...
const Hexadecimal$1 = new GraphQLScalarType({
    name: `Hexadecimal`,
...
const HexColorCode$1 = new GraphQLScalarType({
    name: `HexColorCode`,
...
const HSL$1 = new GraphQLScalarType({
    name: `HSL`,
...
const HSLA$1 = new GraphQLScalarType({
    name: `HSLA`,
...
const IPv4$1 = new GraphQLScalarType({
    name: `IPv4`,
...
const IPv6$1 = new GraphQLScalarType({
    name: `IPv6`,
...
const ISBN$1 = new GraphQLScalarType({
    name: `ISBN`,
...
const MAC$1 = new GraphQLScalarType({
    name: `MAC`,
...
const Port$1 = new GraphQLScalarType({
    name: `Port`,
...
const RGB$1 = new GraphQLScalarType({
    name: `RGB`,
...
const RGBA$1 = new GraphQLScalarType({
    name: `RGBA`,
 ...
 *    currency strings.
 */
const USCurrency$1 = new GraphQLScalarType({
    name: 'USCurrency',
...
const JSON$2 = new GraphQLScalarType({
    name: 'JSON',
...
const JSONObject$1 = new GraphQLScalarType({
    name: 'JSONObject',
...
const IBAN$1 = new GraphQLScalarType({
    name: `IBAN`,
...
const ObjectID$1 = new GraphQLScalarType({
    name: 'ObjectID',
...
export { BigIntMock, BigIntResolver, BigInt$1 as BigIntTypeDefinition, DateTime$2 as DateTimeMock, DateTime$1 as DateTimeResolver, DateTime as DateTimeTypeDefinition, EmailAddress$2 as EmailAddressMock, EmailAddress$1 as EmailAddressResolver, EmailAddress as EmailAddressTypeDefinition, GUID as GUIDDefinition, GUID$2 as GUIDMock, GUID$1 as GUIDResolver, HSLA as HSLADefinition, HSLA$2 as HSLAMock, HSLA$1 as HSLAResolver, HSL as HSLDefinition, HSL$2 as HSLMock, HSL$1 as HSLResolver, HexColorCode as HexColorCodeDefinition, HexColorCode$2 as HexColorCodeMock, HexColorCode$1 as HexColorCodeResolver, Hexadecimal$2 as HexadecimalMock, Hexadecimal$1 as HexadecimalResolver, Hexadecimal as HexadecimalTypeDefinition, IBAN$2 as IBANMock, IBAN$1 as IBANResolver, IBAN as IBANTypeDefinition, IPv4 as IPv4Definition, IPv4$2 as IPv4Mock, IPv4$1 as IPv4Resolver, IPv6 as IPv6Definition, IPv6$2 as IPv6Mock, IPv6$1 as IPv6Resolver, ISBN as ISBNDefinition, ISBN$2 as ISBNMock, ISBN$1 as ISBNResolver, JSON$1 as JSONDefinition, JSON$3 as JSONMock, JSONObject as JSONObjectDefinition, JSONObject$2 as JSONObjectMock, JSONObject$1 as JSONObjectResolver, JSON$2 as JSONResolver, BigIntMock as LongMock, LongResolver, Long as LongTypeDefinition, MAC as MACDefinition, MAC$2 as MACMock, MAC$1 as MACResolver, NegativeFloat$2 as NegativeFloatMock, NegativeFloat$1 as NegativeFloatResolver, NegativeFloat as NegativeFloatTypeDefinition, NegativeInt$2 as NegativeIntMock, NegativeInt$1 as NegativeIntResolver, NegativeInt as NegativeIntTypeDefinition, NonNegativeFloat$1 as NonNegativeFloatMock, NonNegativeFloatResolver, NonNegativeFloat as NonNegativeFloatTypeDefinition, NonNegativeInt$1 as NonNegativeIntMock, NonNegativeIntResolver, NonNegativeInt as NonNegativeIntTypeDefinition, NonPositiveFloat$2 as NonPositiveFloatMock, NonPositiveFloat$1 as NonPositiveFloatResolver, NonPositiveFloat as NonPositiveFloatTypeDefinition, NonPositiveInt$2 as NonPositiveIntMock, NonPositiveInt$1 as NonPositiveIntResolver, NonPositiveInt as NonPositiveIntTypeDefinition, ObjectID$2 as ObjectIDMock, ObjectID$1 as ObjectIDResolver, ObjectID as ObjectIDTypeDefinition, PhoneNumber$2 as PhoneNumberMock, PhoneNumber$1 as PhoneNumberResolver, PhoneNumber as PhoneNumberTypeDefinition, Port as PortDefinition, Port$2 as PortMock, Port$1 as PortResolver, PositiveFloat$2 as PositiveFloatMock, PositiveFloat$1 as PositiveFloatResolver, PositiveFloat as PositiveFloatTypeDefinition, PositiveInt$2 as PositiveIntMock, PositiveInt$1 as PositiveIntResolver, PositiveInt as PositiveIntTypeDefinition, PostalCode$2 as PostalCodeMock, PostalCode$1 as PostalCodeResolver, PostalCode as PostalCodeTypeDefinition, RGBA as RGBADefinition, RGBA$2 as RGBAMock, RGBA$1 as RGBAResolver, RGB as RGBDefinition, RGB$2 as RGBMock, RGB$1 as RGBResolver, RegularExpression, URLMock, URL$2 as URLResolver, URL$1 as URLTypeDefinition, USCurrency as USCurrencyDefinition, USCurrency$2 as USCurrencyMock, USCurrency$1 as USCurrencyResolver, NonNegativeFloat$1 as UnsignedFloatMock, UnsignedFloatResolver, UnsignedFloat as UnsignedFloatTypeDefinition, NonNegativeInt$1 as UnsignedIntMock, UnsignedIntResolver, UnsignedInt as UnsignedIntTypeDefinition, mocks, index as resolvers, typeDefs };
